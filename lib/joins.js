...
Mongo.Collection.prototype.doJoin = function(collectionObject, collectionName, collectionNameField, foreignKey, containerField, fieldList, fieldKey) {
		...
		options.transform = function (doc) {
			_.each(self._joins, function (join) {
				...
				if (coll) {
					...
					doc[container] = __original.findOne.call(coll, {[join.fieldKey]: accessPropertyViaDotNotation(join.foreignKey, doc)}, opt) || {};
				}
			});
...
Mongo.Collection.prototype.join = function(collection, foreignKey, containerField, fieldList, fieldKey) {
	...
	this.doJoin(collectionObject, collectionName, "", foreignKey, containerField, fieldList, fieldKey);
};
